{
  ...
  cfg = config.desktop.shell.wall.waypaper;
in {
  options.desktop.shell.wall.waypaper.enable = lib.mkEnableOption "waypaper wallpaper manager";

  config = lib.mkIf cfg.enable {
    desktop.shell.wall.awww.enable = lib.mkDefault true;
